...
SELECT
    ...
    (count(third_week.user_name)/count(*)) as third_week_retention_rate
FROM first_edits
LEFT JOIN
(
    ...
    -- user is not a bot and not anonymous
        ...
        -- second revision is between 16 and 22 days
...
ON 
(first_edits.user_name = third_week.user_name and
first_edits.first_edit_time = third_week.first_edit_time 
)
GROUP BY
    first_edits.experience_level,
    first_edits.editing_interface;